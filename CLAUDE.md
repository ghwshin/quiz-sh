...
data/
├── linux-kernel/*.json          # 10 subcategory quiz files (25 questions each)
└── android-system/*.json        # 10 subcategory quiz files (25 questions each)
e2e/
...
- 500 questions total: 20 files x 25 questions (10 multiple-choice + 8 fill-in-the-blank + 7 code-fill)
